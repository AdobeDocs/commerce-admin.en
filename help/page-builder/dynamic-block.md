...
description: Learn about the Dynamic Block content type, used to add a reusable dynamic block to the Page Builder stage.
---
# Add Content - Dynamic Block

Use the Dynamic Block content type to add an existing [dynamic block](https://docs.magento.com/user-guide/cms/dynamic-blocks.html) to the [Page Builder stage](workspace.md#stage).
...
1. On the _Edit Dynamic Block_ page, click **Select Dynamic Block** and use the list to select the block.
...
1. To control the positioning of the dynamic block within the parent container, choose an **Alignment**:
...
1. Set the **Border** style that is applied to all four sides of the dynamic block container:
