...
1. Expand ![Expansion selector](../assets/icon-display-expand.png) **[!UICONTROL Advanced Content Tools]** and verify that **Enable Page Builder** is set to `Yes`.
...
1. If you are ready to set up [!DNL Google Maps], do the following:
   ...
   - To change the **Google Maps Style**, paste the JSON code that is generated by the [[!DNL Google Maps] APIs Styling Wizard][2].
...
1. In the left panel under _[!UICONTROL General]_, choose **Web**.
...
1. Expand ![Expansion selector](../assets/icon-display-expand.png) **[!UICONTROL Advanced Content Tools]** and set **Enable Page Builder** to `No`.
