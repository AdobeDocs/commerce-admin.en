...
1. Click the **[!UICONTROL Tab 1]** label to display the individual tab toolbox and choose the _Settings_ ( ![Settings icon](./assets/pb-icon-settings.png){width="20"} ) icon.
