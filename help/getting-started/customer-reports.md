...
|[!UICONTROL Average]|Average order amount. This amount is always calculated for product prices **excluding tax** for any discount applying settings. Even if catalog product prices, order subtotal and order total include tax.|
|[!UICONTROL Total]|The sum of all orders for the period. This amount is always calculated for product prices **excluding tax** for any discount applying settings. Even if catalog product prices, order subtotal and order total include tax.|
