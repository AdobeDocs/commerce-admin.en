...
![Storefront branding elements](./assets/storefront-home-page-branding.png){width="600" zoomable="yes"}
...
![Logo in Header](./assets/storefront-header-logo.png){width="600"}
...
1. On the _Admin_ sidebar, go to **[!UICONTROL Content]** > _[!UICONTROL Design]_ > **[!UICONTROL Configuration]**.
   ...
   ![Design Configuration page](./assets/design-configuration.png){width="700"}
...
1. Expand ![Expansion selector](../assets/icon-display-expand.png) the **[!UICONTROL Header]** section.
   ...
   ![Header settings](./assets/configuration-header.png){width="600"}
...
1. Under _[!UICONTROL Other Settings]_, expand ![Expansion selector](../assets/icon-display-expand.png) the **[!UICONTROL HTML Head]** section.
   ...
   ![HTML Head settings](./assets/configuration-html-head.png){width="600"}
...
![Welcome message](./assets/storefront-welcome-message.png){width="600"}
...
![Copyright notice example](./assets/storefront-footer-copyright.png){width="600"}
...
**_To update the copyright notice:_**
...
1. Under _Other Settings_, expand ![Expansion selector](../assets/icon-display-expand.png)the **[!UICONTROL Footer]** section.
   ...
   ![Footer design settings](./assets/configuration-footer.png){width="600"}
