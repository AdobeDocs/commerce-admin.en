...
1. If you have two-factor authentication (2FA) enabled for the [!DNL Commerce] account, enter the verification code displayed in your 2FA application and click **[!UICONTROL Submit]**.
