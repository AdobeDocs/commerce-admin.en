...
>[!IMPORTANT]
>
>Once enabled, all Admin users must log in via AdobeIms. You cannot exempt specific users from the integration - username and password login is no longer available for individual users.
>
