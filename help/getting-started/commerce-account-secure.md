...
With TFA enabled, your account is more secure. An unauthorized user can not log in unless they have both your username and password credentials (first factor) and a valid verification code from the TFA application on your personal device (second factor).
...
1. To ensure that you can recover access to your account, enter a **[!UICONTROL Recovery Email]**.
   ...
   >[!IMPORTANT]
   >
   >You must maintain access to your Recovery email account. Otherwise, you can not use temporary recovery codes sent to that account.
