...
With TFA enabled, your account is more secure because an unauthorized user can not access your account unless they have both your username and password credentials (first factor) and a valid verification code from the TFA application on your personal device (second factor).
