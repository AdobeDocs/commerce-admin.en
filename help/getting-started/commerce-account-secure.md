...
1. Log in to your [Commerce account][1]{:target="_blank"}.
...
1. Click **Enable** to begin the two-factor authentication setup process.

1. Reenter your **Password** and click **Verify Password** to continue.
...
1. With your two-factor authentication application now synced to your Commerce account, enter the **Verification Code** displayed in your two-factor authentication application and click **Verify Code** to continue.
...
1. Select the confirmation checkbox and click **Submit** to continue.
...
1. Select the confirmation checkbox and click **Submit** to complete the two-factor authentication setup process.
...
1. Go to the Commerce [account login][1]{:target="_blank"}.

1. Enter your username and password combination, and then click **Login** to log into My Account.
...
1. Click **Submit** to complete the login process.
...
1. Click **Use recovery code** to bypass the verification code prompt.
...
1. To have a temporary Recovery Code sent to the Recovery Email address on file for your Commerce account, click the **recovery email** link.
...
1. Select the confirmation checkbox and click **Submit** to close the dialog.
...
1. With your TFA application now synced to your Commerce account, enter the **Verification Code** displayed in your TFA application and click **Verify Code** to continue.
...
1. Select the checkbox to confirm and click **Submit** to continue.
...
1. Click **Disable** to begin the TFA deactivation process.

1. Reenter your password and click **Verify Password** to continue.

   ![Verify password](./assets/commerce-account-2fa-manage-verify-password.png)<!-- zoom -->

1. Select the confirmation checkbox and click **Submit** to complete the deactivation for two-factor authentication.
