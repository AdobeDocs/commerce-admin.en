...
- `mg`: Set by Snowplow JavaScript tracker. More information can be found [here](https://docs.snowplow.io/docs/collecting-data/collecting-from-own-applications/javascript-trackers/javascript-tracker/javascript-tracker-v3/tracker-setup/initialization-options)
- `com.adobe.alloy.getTld`: Of the current web page's hostname, this is the top-most domain that is not a "public suffix" as outlined in https://publicsuffix.org. In other words, this is top-most domain that is able to accept cookies. Is the part of [Alloy](https://github.com/adobe/alloy)
