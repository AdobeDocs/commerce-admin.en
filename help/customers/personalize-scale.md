...
With all of this rich, first-party [!DNL Commerce] data, you are ready to start targeting and personalizing each shopper's experience. In the next section, you learn how [!DNL Commerce] and Adobe Experience Cloud help you create personalized experiences and the use-cases you can activate. 
