...
1. [Data Connection](https://experienceleague.adobe.com/en/docs/commerce/data-connection/overview): Share storefront, back office, and customer profile data from Adobe [!DNL Commerce] to the Adobe Experience Platform edge network for use across Adobe Experience Cloud applications, including: 
    ...
    - [Adobe [!DNL Journey Optimizer]](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/get-started/essentials/get-started): Launch personalized omni-channel journeys, including email campaigns, SMS, push notifications, and more.  
    - [Customer Journey Analytics](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/cja-overview) and [Adobe [!DNL Analytics]](https://experienceleague.adobe.com/en/docs/analytics/analyze/admin-overview/analytics-overview): Gain insights into the customer and the business.
...
1. [[!DNL Audience Activation]](/help/customers/audience-activation.md): Use [!DNL Real-Time CDP] audiences to personalize dynamic content blocks, promotions, and related product rules on your Adobe [!DNL Commerce] site.
...
|Category|Features|
|---|---|
|Personalized Product Discovery|[[!DNL Live Search]](https://experienceleague.adobe.com/en/docs/commerce/live-search/overview): Personalize and optimize search results based on a shopper's onsite behavioral actions and affinities with AI-powered search.<br>[Intelligent Category Merchandising](https://experienceleague.adobe.com/en/docs/commerce/live-search/live-search-admin/category-merch): AI-driven product ranking on category pages based on a shopper's onsite behavioral actions and affinities.<br>[Product Recommendations](https://experienceleague.adobe.com/en/docs/commerce/product-recommendations/guide-overview): AI-powered product recommendations based on shopper behavior, trends, and affinities.<br>[Related Product Rules](/help/merchandising-promotions/product-related-rules.md): Define custom rules to display products from your catalog to drive cross- and up-sell.|
|Personalized Site Content|[Dynamic Content Blocks](/help/content-design/dynamic-blocks.md): Display personalized content blocks, for example, banners, based on customer segments in Adobe Commerce.|
|Personalized Offers and Promotions|[Cart Price Rules](/help/merchandising-promotions/price-rules-cart.md): Apply discounts to items in the shopping cart based on a set of conditions, including customer segments in Adobe [!DNL Commerce].|
...
- Learn how you can use Adobe Journey Optimizer to [send an abandoned cart email](https://experienceleague.adobe.com/en/docs/commerce/data-connection/use-cases/using-ajo).
- Learn how to [create an audience in Real-Time CDP](https://experienceleague.adobe.com/en/docs/commerce/data-connection/use-cases/create-audience) to inform a cart price rule in Adobe [!DNL Commerce].
