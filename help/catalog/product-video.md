...
1. To upload a **[!UICONTROL Preview Image]**, browse to the image and select the file.
   ...
   >[!NOTE]
   >
   >There is no control over how Preview images are looking in Admin. Preview images are automatically generated by external video service providers. And they cannot be edited in Adobe Commerce Admin Panel.
