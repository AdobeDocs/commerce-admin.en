---
title: Product settings - Search Engine Optimization
...
1. Scroll down and expand ![Expansion selector](../assets/icon-display-expand.png) the _Search Engine Optimization_ section.
