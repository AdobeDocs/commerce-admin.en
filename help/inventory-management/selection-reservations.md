...
![Example SSA recommendations for a mountain bike](assets/inventory-diagram-ssa-sources.png)
...
![Reservations from order to delivery](assets/inventory-diagram-quantity.png)
...
![Reservation updates](assets/inventory-diagram-reservation.png)
