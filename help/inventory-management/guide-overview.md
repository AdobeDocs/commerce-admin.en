...
Inventory Management gives you tools to control stock across many locations. Use the Admin for setup and reports. Turn to the command-line interface for advanced changes. Adjust settings, manage sources and stocks, and track every order with confidence. This guide lays out steps and resources for each task.
