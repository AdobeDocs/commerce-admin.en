...
1. **PayPal responds** - PayPal evaluates the request. If found to be valid, PayPal processes the transaction.
...
1. Expand **PayPal All-in-One Payment Solution** and click **Configure** for  **Payments Advanced**.

   ![PayPal Payments Advanced](./assets/paypal-payments-advanced.png)<!-- zoom -->

### Step 2: Complete the required settings

1. Expand ![Expansion selector](../assets/icon-display-expand.png) the **Required PayPal Settings** section, if needed.
...
1. Expand ![Expansion selector](../assets/icon-display-expand.png) the **Basic Settings - PayPal Payments Advanced** section, if needed.
