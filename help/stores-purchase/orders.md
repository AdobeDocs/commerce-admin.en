...
|Control|Description|
|--- |--- |
|Create New Order|Creates a new order. See [Creating an Order](customer-account-create-order.md) for more information.|
