...
1. Expand **PayPal All-in-One Payment Solution** and click **Configure** for **Payments Pro**.

   ![PayPal Payments Pro](./assets/paypal-payments-pro.png)<!-- zoom -->

### Step 2: Complete the required PayPal settings

1. Expand ![Expansion selector](../assets/icon-display-expand.png) the **Payments Pro and Express Checkout** section.
...
1. Expand ![Expansion selector](../assets/icon-display-expand.png) the **Basic Settings - PayPal Payments Pro** section.
