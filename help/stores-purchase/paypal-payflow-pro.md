...
1. Expand **PayPal Payment Gateways** (if needed) and click **Configure** for **Payflow Pro**.
...
1. Expand ![Expansion selector](../assets/icon-display-expand.png) the **Basic Settings - PayPal Payflow Pro** section.
