...
![Product File Attributes](./assets/file-validation.png)
...
|[!UICONTROL Maximum File Size]|Global|The maximum allowed file size in MB, such as `20.0`. The default limit is 16 MB.|
