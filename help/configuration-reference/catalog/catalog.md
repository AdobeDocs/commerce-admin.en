...
|[!UICONTROL Apply transliteration for product URL]|Store View| Determines if transliteration should be applied or not when creating a product URL. Options: `Yes` / `No`                                                                                                                                                                                                                                                                                                |
