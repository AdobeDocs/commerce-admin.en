...
>[!NOTE]
>
>[Reward Exchange Rates](../../merchandising-promotions/reward-exchange-rates.md) configuration is required for redemption of reward points by customers and admins during checkout.
...
|[!UICONTROL Deduct Reward Points from Refund Amount Automatically]|Global| This determines if reward points earned through purchases are fully or partially voided on order refund, when this feature is enabled. Only reward points from the order that earned them are affected when that order is refunded. Options: `Yes` / `No`.                                                                                                                                                                                                                                                                                                |
...
|Field|[Scope](../../getting-started/websites-stores-views.md#scope-settings)| Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|--- |--- |----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|[!UICONTROL Purchase]|Website| Determines if rewards points are earned for the purchases based on the configured [Reward Exchange Rates](../../merchandising-promotions/reward-exchange-rates.md). Options: `Yes` / `No`                                                                                                                                                                                                                                                                                                                                                                                                      |
