---
title: Customers > Customer Configuration
...
|Show Tax/VAT Number|Website|Determines if the Tax or [VAT number](https://docs.magento.com/user-guide/tax/vat.html) is included in the name and address form. Options: No / Optional / Required|
