...
See [Country Options](https://docs.magento.com/user-guide/stores/country-options.html) for specific configuration fields and options.
...
See [State Options](https://docs.magento.com/user-guide/stores/state-options.html) for specific configuration fields and options.
...
See [Locale Options](https://docs.magento.com/user-guide/stores/locale-options.html) for specific configuration fields and options.
...
|Store Phone Number|Store View|The primary telephone number of the store (associated with the store view) is open for business. For example: Mon - Fri, 9-5, Sat 9-noon PST|
|Country|Website|The country of the business that operates the website.|
|Region/State|Website|The region or state of the business that operates the website.|
|ZIP/Postal Code|Website|The ZIP or postal code of the business that operates the website.|
|City|Website|The city location of the business that operates the website.|
