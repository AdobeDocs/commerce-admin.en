---
title: Sales > Payment Methods > PayPal Express Checkout
...
<!-- PayPal Express Checkout Required Settings_](../../stores-purchase/paypal-express-checkout.html) -->
...
|Proxy Host|Website|If the API uses proxy, this specifies the IP address of the proxy host.|
|Proxy Port|Website|If the API uses proxy, this specifies the port used by the proxy host.|
