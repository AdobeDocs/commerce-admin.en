---
title: Sales > Payment Methods > PayPal Payments Advanced
...
|Test Mode|Website|When enabled, runs PayPal Payments Advanced in a testing  environment. Turn off test mode when you are ready to "go live" in production mode. Options: `Yes` / `No`|
...
|Field|[Scope](../../getting-started/websites-stores-views.md#scope-settings)|Description|
|--- |--- |--- |
|PayPal Product Logo|Store View|Determines the PayPal logo that appears in your store. There are four basic styles in two sizes. Options: <br/>No Logo<br/>We prefer PayPal (150 x 60)<br/>We prefer PayPal (150 x 40)<br/>Now accepting PayPal (150 x 60)<br/>Now accepting PayPal (150 x 40)<br/>Payments by PayPal (150 x 60)<br/>Payments by PayPal (150 x 40)<br/>Shop now using (150 x 60)<br/>Shop now using (150 x 40)|
