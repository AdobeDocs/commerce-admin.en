...
|Default Expiration Period|Website|Determines the default lifespan of a [quote](https://docs.magento.com/user-guide/sales/quote-price-negotiation.html) as a number of days, weeks, or months from the date the request for a quote is submitted. Options: `Days` / `Weeks` / `Months`|
...
|Field|[Scope](../../getting-started/websites-stores-views.md#scope-settings)|Description|
|--- |--- |--- |
|File formats for upload|Global|Determines the file formats that can be attached to a quote. Default values supported: `doc`, `docx`, `xls`, `xlsx`, `pdf`, `txt`, `jpg`, `png`, and `jpeg`|
