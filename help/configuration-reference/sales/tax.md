...
|Tax Class for Gift Options|Website|![Adobe Commerce](../../assets/adobe-logo.svg) (Adobe Commerce only) Identifies the default tax class that is used for gift options.|
...
|Additionally Show Order Total Without Tax|Store View|Determines if an extra line with the grand total amount without tax is displayed in the shopping cart. Options: `Yes` / `No`|
...
|Additionally Show Order Total Without Tax|Store View|Determines if an extra line with the grand total amount without tax is displayed on sales documents. Options include: Yes / No|
...
|Display Gift Wrapping Prices|Store View|![Adobe Commerce](../../assets/adobe-logo.svg) (Adobe Commerce only) Determines if gift-wrapping prices are included in the subtotal. Options: `Excluding Tax` / `Including Tax` / `Including and Excluding Tax`|
|Display Printed Card Prices|Store View|![Adobe Commerce](../../assets/adobe-logo.svg) (Adobe Commerce only) Determines if printed card prices are included in the subtotal. Options: `Excluding Tax` / `Including Tax` / `Including and Excluding Tax`|
