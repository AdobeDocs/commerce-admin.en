...
The XML layout of your [!DNL Commerce] store is a hierarchical structure of containers and blocks. Some elements appear on every page, and others appear only on specific pages. To learn more about layout, containers, and blocks, see the [Layouts overview](https://developer.adobe.com/commerce/frontend-core/guide/layouts/) in the _Frontend Developer Guide_.
...
The following steps show how to use a layout update to place a block on a page. For specific examples and help with syntax, see [Common layout customization tasks](https://developer.adobe.com/commerce/frontend-core/guide/layouts/) in the _Frontend Developer Guide_.
...
1. Save the [layout instructions](https://developer.adobe.com/commerce/frontend-core/guide/layouts/xml-instructions/) on the server in the layout folder where XML files are saved for the theme.
   ...
   |Layout Update Name|The option that appears for _Custom Layout Update_.|
...
1. To display all available layout updates that are associated with the page, click the **[!UICONTROL Custom Layout Update]** menu.
...
1. In the message at the top of the workspace, click **[!UICONTROL Cache Management]** and refresh all the invalid cache items.
