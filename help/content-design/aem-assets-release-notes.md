...
![New issue](../assets/new.svg)<!-- Issue ACAP-955 --> Now, a [Custom Domain URL](/help/content-design/aem-assets-setup-synchronization.md#configure-the-custom-domain-url) can be used instead of the AEM Delivery URL. If a merchant sets a **Custom Domain Name** in their AEM dashboard, it is necessary to add this **Custom Domain URL** in Commerce.
...
![New issue](../assets/new.svg)<!-- Issue ACAP-xx --> Now, the [Assets selector IMS Client ID](/help/content-design/aem-assets-setup-synchronization.md) is required by the Assets Selector to enable mapping AEM Assets images with product categories and Page Builder generated content.
