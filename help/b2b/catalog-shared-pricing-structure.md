...
description: With Adobe Commerce B2B, learn about setting up the pricing and structure of a shared catalog.
...
![Products in Catalog](./assets/shared-catalog-products-workspace.png){width="700" zoomable="yes"}
...
1. For the shared catalog in the grid, go to the _[!UICONTROL Action]_ column and click **[!UICONTROL Set Pricing and Structure]**.
   ...
   ![Set pricing and structure for shared catalog](./assets/shared-catalog-set-pricing-structure.png){width="700" zoomable="yes"}
...
1. Use the **Store** chooser to set the [scope](../catalog/introduction.md#product-scope) of the configuration.
   ...
   ![Choose Store](./assets/shared-catalog-products-scope.png){width="600" zoomable="yes"}
...
You can set custom pricing for each product individually or use the _[!UICONTROL Action]_ control to set custom pricing as a fixed amount or percentage for multiple product records.
...
![Select Products for Catalog](./assets/shared-catalog-custome-prices-step-3.png){width="600" zoomable="yes"}

### Apply a custom price

1. For a multi-site installation, set **[!UICONTROL Website]** to the website where the custom prices apply.

   ![Choose Website](./assets/shared-catalog-scope-pricing.png){width="600" zoomable="yes"}
...
1. Use one of the following methods to select the products where the custom pricing is to apply.
   ...
   ![Select All](./assets/shared-catalog-custom-pricing-mass-actions.png){width="600" zoomable="yes"}
...
1. When prompted, enter the discount or price adjustment and click **[!UICONTROL Apply]**.
   ...
   ![Custom Price Column with Discount](./assets/shared-catalog-set-custom-prices-discount-applied.png){width="600" zoomable="yes"}
...
1. For the product in the grid, go to the _Tier Price_ column and click **[!UICONTROL Configure]**.
   ...
   ![Configure Tier Price](./assets/shared-catalog-tier-price-configure.png){width="600" zoomable="yes"}

1. On the _Advanced Pricing_ page, click **[!UICONTROL Add Price]** and do the following:

   ![Catalog and Tier Price](./assets/shared-catalog-tier-price-configure-add-price.png){width="600" zoomable="yes"}
   ...
   - To enter another tier, click **Add Price** and repeat the process to define the next tier.

   ![Multiple Tier Prices](./assets/shared-catalog-tier-price-configure-multiple-tiers.png){width="600" zoomable="yes"}
...
When the custom pricing is complete, click **[!UICONTROL Generate Catalog]** then **[!UICONTROL Save]**.

The shared catalog is now saved to the database. Its name appears in the _[!UICONTROL Shared Catalog]_ column of the _[!UICONTROL Products]_ grid. The next step is to [assign the shared catalog to a company](./catalog-shared-assign-companies.md).
