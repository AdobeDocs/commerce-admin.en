...
|[!UICONTROL Discard Subsequent Rules]|Determines if additional rules can be applied to this purchase. Enable this option to prevent multiple discounts from being applied to the same purchase. Options: `Yes` / `No`|
