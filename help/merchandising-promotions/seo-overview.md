...
1. Scroll down and expand ![Expansion selector](../assets/icon-display-expand.png) the **[!UICONTROL Search Engine Robots]** section and do the following:
    ...
    - Set **[!UICONTROL Default Robots]** to one of the following:
      ...
      |`INDEX, NOFOLLOW`|Instructs web crawlers to index the site once, but do not follow any links on the page.|
      |`NOINDEX, NOFOLLOW`|Instructs web crawlers to avoid indexing the site, and to not follow any links on the page.|
