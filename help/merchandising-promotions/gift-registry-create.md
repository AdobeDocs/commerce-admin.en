...
1. In the upper-right corner, click **Add Gift Registry Type**.
...
1. In the left panel, choose **Attributes** and click **Add Attribute**.
...
1. For each attribute, do the following:
   ...
   - If the input type has multiple options, click **Add New Option** and complete the information for each option.
...
|Event Country|Displays the attribute as a list of countries. Options: <br/>**Searchable** - Determines if the attribute is available for Advanced Search. Options: `Yes` / `No`.<br/>**Is Listed** - Determines if the event is included in the list of events that is available in the store. Options: `Yes` / `No`. <br/>**Show Region** - Determines the region of the event.|
