...
| [!UICONTROL Webhooks Response Cache]| Caches responses to webhook requests. For more information, see [Adobe Commerce Webhooks Guide](https://developer.adobe.com/commerce/extensibility/webhooks/release-notes/#enhancements-2) in the developer documentation.                                | `WEBHOOKS_RESPONSE` | `webhooks_response`|
...
| [!UICONTROL Admin UI SDK Cache] | Caches customizations to the Admin. See [Admin configuration and testing](https://developer.adobe.com/commerce/extensibility/admin-ui-sdk/configuration/) in the _Adobe Commerce Admin UI SDK Guide_. | `ADMIN_UI_SDK`             | `admin_ui_sdk` |
