...
[_Front-end Development Workflow_](https://docs.magento.com/user-guide/configuration/advanced/developer.html)

1. On the _Admin_ sidebar, go to **Stores** > _Settings_ > **Configuration**.

1. In the left panel, expand **Advanced** and choose **Developer**.

1. Expand ![Expansion selector](../assets/icon-display-expand.png) the **Front-end Development Workflow** section.
...
[_Static File Settings_](https://docs.magento.com/user-guide/configuration/advanced/developer.html)
...
1. To optimize CSS files, expand ![Expansion selector](../assets/icon-display-expand.png) the **CSS Settings** section and do the following:
...
1. To optimize JavaScript files, expand ![Expansion selector](../assets/icon-display-expand.png) the **JavaScript Settings** section and do the following:
   ...
   [_JavaScript Settings_](https://docs.magento.com/user-guide/configuration/advanced/developer.html)

1. To minify PHTML template files, expand ![Expansion selector](../assets/icon-display-expand.png) the **Template Settings** section and set **Minify Html** to `Yes`.

   ![Advanced configuration - template settings](../configuration-reference/advanced/assets/developer-template-settings.png)<!-- zoom -->

   [_Template Settings_](https://docs.magento.com/user-guide/configuration/advanced/developer.html)

1. When complete, click **Save Config**.

## Client restrictions

Before using a tool such as [template path hints](#template-path-hints), make sure to add your IP address to the Developer Client Restrictions  allow list to avoid disrupting the shopping experience of customers in the store. If you don't know your IP address, you can search for it online.
...
**_To add your IP address to the allow list:_**

1. On the _Admin_ sidebar, go to **Stores** > _Settings_ > **Configuration**.

1. In the left panel, expand **Advanced** and choose **Developer**.

1. Expand ![Expansion selector](../assets/icon-display-expand.png) the **Developer Client Restrictions** section.
   ...
   [_Developer Client Restrictions_](https://docs.magento.com/user-guide/configuration/advanced/developer.html)
...
Before using template path hints, add your IP address to the [allow list](#client-restrictions) to avoid interference with customers who are shopping in the store. When you are finished, make sure to clear the Commerce cache to remove all hints from the store.
...
1. Expand ![Expansion selector](../assets/icon-display-expand.png) the **Debug** section and do the following:

   ![Advanced configuration - debug](../configuration-reference/advanced/assets/developer-debug.png)<!-- zoom -->

   [_Debug_](https://docs.magento.com/user-guide/configuration/advanced/developer.html)
...
1. Set the **Actions** control to `Disable` and click **Submit**.
...
1. Expand ![Expansion selector](../assets/icon-display-expand.png) the **Translate Inline** section.
   ...
   [_Translate Inline_](https://docs.magento.com/user-guide/configuration/advanced/developer.html)
...
1. Set the **Actions** control to `Enable` and click **Submit**.
