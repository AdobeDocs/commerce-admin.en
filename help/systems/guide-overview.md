...
| [Data transfer](data-transfer.md) | The import and export tools give you the ability to manage multiple records in a single operation. You can not only import new items, but also update, replace, and delete existing sets of products. You also have options to track and manage data synchronization between Adobe Commerce and connected Commerce SaaS services from the Data Feed Sync Status and Data Management Dashboard. |
