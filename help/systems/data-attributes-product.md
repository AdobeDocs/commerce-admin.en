...
|tier_price_customer_group|Identifies the [customers groups](https://docs.magento.com/user-guide/customers/customer-groups.html) where tier pricing is available. For example: -  ALL GROUPS -  NOT LOGGED IN -  General -  Wholesale -  Retailer|
